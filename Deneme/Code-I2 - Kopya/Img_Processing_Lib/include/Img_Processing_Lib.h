...
// 3x3 sharpener
static const int HighPass_3x3 []={-1,-1,-1,-1,9,-1,-1,-1,-1};
...
class Img_Processing_Lib
{
    public:
        ...
        void MaxFilter(unsigned char*_intImgData,unsigned char*_outImgData,int imgCols, int imgRows);
        void MedianFilter(unsigned char*_intImgData , unsigned char*_outImgData,int imgCols, int imgRows);
        void MinFilter(unsigned char*_intImgData , unsigned char*_outImgData,int imgCols, int imgRows);
